...
export const SITE_FIELDS = [
  {
    ...
    localized: true,
    multiline: true,
    hint: 'What search engines show about the company in their structured data.',
  },
  ...
  },
  {
    ...
    hint: 'The canonical origin for search engines, sitemaps and share links. Include https://.',
  },
  {
    key: 'logoUri',
    label: 'Structured-data logo path',
    localized: false,
    group: 'Brand',
    hint: 'Site path of the logo search engines show, e.g. /assets/logos/logo.png.',
  },
  {
    key: 'faviconUri',
    label: 'Browser-tab icon path',
    localized: false,
    group: 'Brand',
    hint: 'Site path of the tab icon, e.g. /assets/logos/favicon.png.',
  },
